...
public interface TaskNoteService {
	 ...
	 * @return
	 */
	TaskNote createComment(TaskId taskId, String taskNoteOwner, Date writeDate,String comment);
	TaskNote createContribution(TaskId taskId, String taskNoteOwner, Date writeDate,int progress, int contributioin);
